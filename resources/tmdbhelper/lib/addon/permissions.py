class PermissionHandler:
    ...
    # Any module name (relative to tmdbhelper.lib.) that exactly matches an item
    # in _DENY is prevented from being imported outside of tmdbhelper.lib
    _DENY = (
    )

    # Any module name (relative to tmdbhelper.lib.) that starts with an item in
    # _DENY_ALL is prevented from being imported outside of tmdbhelper.lib
    _DENY_ALL = (
        'api.api_keys.',
    )

    # Any module name (relative to tmdbhelper.lib.) that exactly matches an item
    # in _ALLOW is allowed to be imported from outside of tmdbhelper.lib
    _ALLOW = (
        'api.tmdb.api',
    )

    # Any module name (relative to tmdbhelper.lib.) that starts with an item in
    # _ALLOW_ALL is allowed to be imported from outside of tmdbhelper.lib
    _ALLOW_ALL = (
        'player.',
    )
    ...
    # when imported from outside of tmdbhelper.lib
    _RESTRICT = (
    )
